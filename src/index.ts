...
import { IDeal, ILand } from './schema/deal'
import './_function/index'
import fs from 'fs'
import path from 'path'
import { landLangMapping, dealLangMapping } from './schema/languageMapping'
...
(async () => {
  ...
  for (let i = 0; i < counties.length; i++) {
    ...
    // 讀取檔案
    // const deals = await readCsvFileApr<IDeal>(`./repository/${county}/merged/deal.csv`)
